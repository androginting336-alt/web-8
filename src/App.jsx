...
// --- 1. AUTH SCREEN (PROFESSIONAL LANDING) ---
...
function AmbasaltMainApp({ mode, onBack, user }) {
  ...
  // --- API LOGIC (MANUAL FETCH) ---
  const callGeminiWithRetry = async (payload, maxRetries = 2) => {
    let attempt = 0;
    while (attempt <= maxRetries) {
      try {
        // Menggunakan model 2.5-flash-preview yang stabil untuk environment ini
